	...
	export const alertVariants = tv({
		...
		variants: {
			variant: {
				...
				success: "border-emerald-500/30 bg-emerald-50 text-emerald-700 *:data-[slot=alert-description]:text-emerald-700/90 *:[svg]:text-current",
				warning: "border-amber-500/35 bg-amber-50 text-amber-950 *:data-[slot=alert-description]:text-amber-950/90 *:[svg]:text-current",
			},
		},
		defaultVariants: {
			variant: "default",
